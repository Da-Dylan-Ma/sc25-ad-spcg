...
# Define matrices array (same as GPU scripts)
matrices=(
...
# Loop through each matrix and generate the corresponding job script
...
# Find all job_submit_cpu_*.sh files and submit them with sbatch
