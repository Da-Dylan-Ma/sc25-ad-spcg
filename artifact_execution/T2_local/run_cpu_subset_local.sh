...
echo "=========================================="
echo "Running CPU subset jobs locally..."
echo "=========================================="
...
matrices=(
    ...
    "bcsstm09" "bcsstm11" "bcsstk12" "bcsstm21" "bcsstm23" "bcsstm24" "bcsstm25" "bcsstm26" 
...
for matrix in "${matrices[@]}"; do
    ...
    output_file="${RESULTS_DIR}/cpu_subset_${matrix}.out"
    ...
    for ratio in 0.01 0.05 0.10; do
        ...
        if [ -f "${matrix_B}" ]; then
            ...
            perturbed_output="${RESULTS_DIR}/cpu_subset_${matrix}_${ratio}.out"
...
echo "=========================================="
echo "CPU subset local execution completed!"
echo "=========================================="
echo "Summary:"
