...
# GPU ILU0 Subset Local Execution Script
# This script compiles and runs both the nonsp and sp versions of the ILU0 GPU implementation locally

echo "Starting GPU ILU0 subset compilation and local execution..."
...
echo "=========================================="
echo "All GPU ILU0 subset compilations completed successfully!"
echo "=========================================="
...
# Run jobs locally
echo "=========================================="
echo "Running GPU ILU0 subset jobs locally..."
echo "=========================================="
...
run_jobs_locally() {
    ...
    echo "Running subset jobs locally for ${dir_name}..."
    ...
    for matrix in "${matrices[@]}"; do
        ...
        if [ "$dir_name" = "nonsp" ]; then
            ...
            output_file="${results_dir}/ilu0_subset_${dir_name}_${matrix}.out"
            ...
            for ratio in 0.01 0.05 0.1; do
                output_file="${results_dir}/ilu0_subset_${dir_name}_${matrix}_${ratio}.out"
    ...
    echo "Completed all subset jobs for ${dir_name}. Results saved to: ${results_dir}/"
...
echo "=========================================="
echo "GPU ILU0 subset local execution completed successfully!"
echo "=========================================="
